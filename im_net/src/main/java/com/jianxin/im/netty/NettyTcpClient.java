package com.jianxin.im.netty;


import android.text.TextUtils;
import android.util.Log;

import com.jianxin.im.ExecutorServiceFactory;
import com.jianxin.im.netty.handler.HeartbeatHandler;
import com.jianxin.im.MsgDispatcher;
import com.jianxin.im.netty.handler.timeout.MsgTimeoutTimerManager;
...
import com.jianxin.im.netty.handler.TCPChannelInitializerHandler;
...
public class NettyTcpClient implements IMSClientInterface {
    ...
    private class ResetConnectRunnable implements Runnable {
        ...
        @Override
        public void run() {
            Log.e("abc","========init======ResetConnectRunnable");
