package com.jianxin.chat.im.netty.handler.timeout;
        ...
        public void run() {
            ...
            if (currentResendCount > imsClient.getResendCount()) {
                ...
                try {
                    ...
                    headBuilder.setStatus(2);
                    headBuilder.setFrom(msg.getHead().getFrom());
                    headBuilder.setTarget(msg.getHead().getTarget());
