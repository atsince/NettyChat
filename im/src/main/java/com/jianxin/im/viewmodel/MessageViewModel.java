...
import com.jianxin.chat.bean.message.ImageMessageContent;
...
public class MessageViewModel extends ViewModel implements OnReceiveMessageListener,
    ...
    public MessageViewModel() {
       ...
       // ChatManager.getInstance().addRecallMessageListener(this);
        ...
        ChatManager.getInstance().addOnMessageUpdateListener(this);
    ...
    protected void onCleared() {
       ...
       // ChatManager.getInstance().removeRecallMessageListener(this);
        ...
        ChatManager.getInstance().removeOnMessageUpdateListener(this);
...
//        ChatManager.getInstance().recallMessage(message, new GeneralCallback() {
//            @Override
...
//
    public void deleteMessage(Message message) {
       ...
       // ChatManager.getInstance().deleteMessage(message);
    }
...
//            ChatManager.getInstance().setMediaMessagePlayed(message.message.messageId);
//        }
//
...
//        String thumbParam = ChatManager.getInstance().getImageThumbPara();
//        if (!TextUtils.isEmpty(thumbParam)) {
//            imgContent.setThumbPara(ChatManager.getInstance().getImageThumbPara());
//        }
...
//    }
    ...
    private void postNewMessage(UiMessage message) {
        Log.e("abc","onReceiveMessage==postNewMessage==1111");
        if (message == null || message.message == null) {
            return;
        }
        if (messageLiveData != null) {
