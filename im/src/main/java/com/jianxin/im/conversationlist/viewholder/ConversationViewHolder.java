...
import com.jianxin.im.annotation.ConversationContextMenuItem;
import com.jianxin.im.conversation.ConversationActivity;
import com.jianxin.im.conversationlist.ConversationListViewModel;
import com.jianxin.im.conversationlist.ConversationListViewModelFactory;
import com.jianxin.im.conversationlist.notification.viewholder.ConversationContextMenuItemTags;
...
//                    } else {
    ...
    public void onClick(View itemView) {
        ...
        intent.putExtra("conversationTitle", ChatManager.getInstance().getUserId() +"-"+conversationInfo.conversation.target);
