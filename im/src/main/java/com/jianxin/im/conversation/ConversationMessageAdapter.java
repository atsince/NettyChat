...
import com.jianxin.im.conversation.message.MessageItemView;
import com.jianxin.im.conversation.message.model.UiMessage;
import com.jianxin.im.conversation.message.viewholder.LoadingViewHolder;
import com.jianxin.im.conversation.message.viewholder.MessageContentViewHolder;
import com.jianxin.im.conversation.message.viewholder.MessageViewHolderManager;
import com.jianxin.im.conversation.message.viewholder.NormalMessageContentViewHolder;
import com.jianxin.im.conversation.message.viewholder.NotificationMessageContentViewHolder;
...
//                }).show();
    ...
    public int getItemViewType(int position) {
       ...
       int type= msg.direction.value() << 24 | msg.content.getType();
        return type;
    }
